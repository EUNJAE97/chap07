...
public class Computer extends Product {
    ...
    public Computer(String code, String brand, String name, int price, Date manufaturingDate, String cpu, int hdd, int ram, String operationSystem) {
        super(code, brand, name, price, manufaturingDate); // 부모 클래스의 매개변수 생성자 호출
        /* 위에 작성된 생성자를 this()로 호출한다는 것은 super()를 두 번 호출한다는 것과 같기 때문에 호출 안된다.*/
    ...
    public String getInformation() {
        /* 부모 클래스의 private 멤버에는 직접 접근이 불가하여 getter 메소드로 접근함.
