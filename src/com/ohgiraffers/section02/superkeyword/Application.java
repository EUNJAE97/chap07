...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* Product 매개변수 생성자 */
        Product product2 = new Product("S-01234", "SAMSUNG", "갤럭시Z폴드4", 2389000, new Date());
        ...
        /* Computer,Product 모든 필드 초기화 생성자 */
        Computer computer3 = new Computer("S-01234", "SAMSUNG", "갤럭시Z폴드4", 2389000, new Date(),"퀼컴 스냅드래곤",512,12,"안드로이드");
        System.out.println(computer2.getInformation());
    }
}
